...
const artworks: Artwork[] = [
  {
    id: 1, titleKo: "봄의 환희", titleEn: "Joy of Spring", year: "2023",
    medium: "실크 염색 · 아크릴",
    url: "https://images.unsplash.com/photo-1585157603289-34f674d97504?w=420&h=560&fit=crop&auto=format",
    alt: "Watercolor cherry blossoms painting",
  },
  {
    id: 2, titleKo: "겨울 벚꽃", titleEn: "Winter Blossoms", year: "2022",
    medium: "실크 염색 · 아크릴",
    url: "https://images.unsplash.com/photo-1585157603253-7b3e36555495?w=420&h=560&fit=crop&auto=format",
    alt: "Watercolor cherry blossom branch",
  },
  {
    id: 3, titleKo: "흰 꽃의 속삭임", titleEn: "White Flower Whisper", year: "2022",
    medium: "실크 염색",
    url: "https://images.unsplash.com/photo-1691670353223-535d0cc431de?w=420&h=560&fit=crop&auto=format",
    alt: "Delicate white blossoms painting",
  },
  {
    id: 4, titleKo: "진달래", titleEn: "Azalea", year: "2021",
    medium: "실크 염색 · 아크릴",
    url: "https://images.unsplash.com/photo-1723578154758-c88bad35875c?w=420&h=560&fit=crop&auto=format",
    alt: "Azalea flower painting with decorative elements",
  },
  {
    id: 5, titleKo: "청화 꽃병", titleEn: "Blue & White Vase", year: "2021",
    medium: "아크릴",
    url: "https://images.unsplash.com/photo-1700212964111-9e6ce16aeb1e?w=420&h=560&fit=crop&auto=format",
    alt: "Blue and white flowers in a vase painting",
  },
  {
    id: 6, titleKo: "나비와 꽃", titleEn: "Butterfly & Flower", year: "2020",
    medium: "실크 염색",
    url: "https://images.unsplash.com/photo-1762860498305-c359b744039e?w=420&h=560&fit=crop&auto=format",
    alt: "White butterflies near a flower painting",
  },
  {
    id: 7, titleKo: "순백의 정원", titleEn: "Garden of White", year: "2020",
    medium: "실크 염색 · 아크릴",
    url: "https://images.unsplash.com/photo-1700212964198-0862f30fb2ad?w=420&h=560&fit=crop&auto=format",
    alt: "White flowers and green leaves painting",
  },
  {
    id: 8, titleKo: "여름의 열정", titleEn: "Summer Passion", year: "2019",
    medium: "아크릴",
    url: "https://images.unsplash.com/photo-1580715911279-6bc35abc2e4e?w=420&h=560&fit=crop&auto=format",
    alt: "Red and yellow flowers painting",
  },
  {
    id: 9, titleKo: "연분홍 노래", titleEn: "Song in Pink", year: "2018",
    medium: "실크 염색",
    url: "https://images.unsplash.com/photo-1762860497966-5933eead2fbf?w=420&h=560&fit=crop&auto=format",
    alt: "Delicate pink flowers painting",
  },
  {
    id: 10, titleKo: "꽃, 기억", titleEn: "Flower, Memory", year: "2017",
    medium: "실크 염색 · 아크릴",
    url: "https://images.unsplash.com/photo-1713117223319-4dbd75b40c3d?w=420&h=560&fit=crop&auto=format",
    alt: "Bunch of flowers on a table painting",
  },
]
            ...
            {[0, 1, 2].map((i) => (
              <span
                ...
                style={{
                  ...
                  transform: menuOpen
                    ? i === 0 ? "translateY(5px) rotate(45deg)" : i === 2 ? "translateY(-5px) rotate(-45deg)" : "none"
                    : "none",
                }}
              />
            ))}
